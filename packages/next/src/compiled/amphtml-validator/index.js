;(() => {
  var e = {
    ...
    52: (e, r, t) => {
      ...
      function handleResolved(e, r) {
        n(function () {
          var t = e._y === 1 ? r.onFulfilled : r.onRejected
          if (t === null) {
            if (e._y === 1) {
              resolve(r.promise, e._z)
            } else {
              reject(r.promise, e._z)
            }
            return
          }
          var n = tryCallOne(t, e._z)
          if (n === i) {
            reject(r.promise, o)
          } else {
            resolve(r.promise, n)
    ...
    751: (e, r, t) => {
      ...
      function onSettledFulfill(e) {
        return { status: 'fulfilled', value: e }
      }
      function onSettledReject(e) {
        return { status: 'rejected', reason: e }
      }
      function mapAllSettled(e) {
        if (e && (typeof e === 'object' || typeof e === 'function')) {
          if (e instanceof n && e.then === n.prototype.then) {
            return e.then(onSettledFulfill, onSettledReject)
          }
          var r = e.then
          if (typeof r === 'function') {
            return new n(r.bind(e)).then(onSettledFulfill, onSettledReject)
          }
        }
        return onSettledFulfill(e)
      }
      n.allSettled = function (e) {
        return n.all(iterableToArray(e).map(mapAllSettled))
      }
      n.reject = function (e) {
        return new n(function (r, t) {
          t(e)
      ...
      function getAggregateError(e) {
        if (typeof AggregateError === 'function') {
          return new AggregateError(e, 'All promises were rejected')
        }
        var r = new Error('All promises were rejected')
        r.name = 'AggregateError'
        r.errors = e
        return r
      }
      n.any = function promiseAny(e) {
        return new n(function (r, t) {
          var o = iterableToArray(e)
          var i = false
          var s = []
          function resolveOnce(e) {
            if (!i) {
              i = true
              r(e)
            }
          }
          function rejectionCheck(e) {
            s.push(e)
            if (s.length === o.length) {
              t(getAggregateError(s))
            }
          }
          if (o.length === 0) {
            t(getAggregateError(s))
            ...
            o.forEach(function (e) {
              n.resolve(e).then(resolveOnce, rejectionCheck)
            })
          }
        })
      }
    ...
    318: (e) => {
      'use strict'
      e.exports = require('next/dist/compiled/commander')
    },
    37: (e) => {
      'use strict'
  ...
  ;(() => {
    ...
    const { program: a } = __nccwpck_require__(318)
    const u = __nccwpck_require__(356)
    const l = __nccwpck_require__(837)
    const f = __nccwpck_require__(144)
    const c = 'amphtml-validator'
    ...
    function Validator(e) {
      this.sandbox = f.createContext()
      try {
        new f.Script(e).runInContext(this.sandbox)
      } catch (e) {
        throw new Error(
    ...
    function getInstance(e, r) {
      ...
      const n = r || c
      console.log({ validatorPath: t, userAgent: n})
      if (p.hasOwnProperty(t)) {
        return u.resolve(p[t])
      }
